...
```json
{"username":"<username>","role":"Admin","permissions":["access_catalog","administrator","manage_catalog","can_provision"],"sub":"<username>","iss":"KNOXSSO","aud":"DSX","uid":"<uid>","authenticator":"default","accessToken":"<redacted>","_messageCode_":"success","message":"success"}
```
